...
def parse_sitemap(sitemap_url: str, directories: list[str] | None = None) -> list[str]:
    """
    ...
    if directories:
        ...
        normalized_dirs = [
            dir_path if dir_path.startswith("/") else "/" + dir_path
            for dir_path in directories
        ]
        normalized_dirs = [
            dir_path if dir_path.endswith("/") else dir_path + "/"
