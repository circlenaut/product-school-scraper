...
def test_estimate_time(mocker):
    ...
    mock_logger.assert_any_call("Estimating time for sitemap at: https://example.com/sitemap.xml")
...
def test_estimate_time_with_default_average_time(mocker):
    ...
    mock_logger.assert_any_call("No average request time found in DB. Using default: 1.00 seconds")
